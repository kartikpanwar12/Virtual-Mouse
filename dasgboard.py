...
class AttendanceApp:
    def __init__(self, root):
        ...
        # ✅ Store default background for restoring highlight properly
        self.default_bg = self.listbox.cget("bg")
    ...
    def highlight_new(self, item_idx):
        """Flash a listbox item in green and then restore original bg"""
        self.listbox.itemconfig(item_idx, bg="green", fg="white")
        self.root.after(800, lambda: self.listbox.itemconfig(item_idx, bg=self.default_bg, fg="black"))
